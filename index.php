	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>To ensure anybody travelling always travel safely upto their destination
                safely and comfortably.</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>Explore the world ,enjoy its beaty and inform people of the beautiful
                 things they are missing out there.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>Every traveller to ensure his/her safety by reporting any reckless
                driving to the relevant authorities.</p>
		 </div>
	 </div>
</div>
<!--/About-->
...
<div id="section-5" class="contact section">
	  <div class="contact-head text-center">
		  <h3>Contact Us</h3>
		  <br>
		  <h4 style="color:#000">Plan Your Trip Today</h4>
		  <br>
		  <h5 style="color:#000">Our travel experts can help you book now or if need be later</h5>
